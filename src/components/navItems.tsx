...
// Not part of NAV_ITEMS (the primary "Workspace" list) — Settings is
// account-level, reached by clicking the profile row in the sidebar footer.
// Exported separately so TopBar can still show a matching header for it.
