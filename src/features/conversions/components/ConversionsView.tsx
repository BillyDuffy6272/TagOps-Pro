...
interface Props {
  session: Session
  pendingGoogleAdsRefreshToken?: string | null
  onConsumePendingGoogleAdsRefreshToken?: () => void
}

export default function ConversionsView({
  session,
  pendingGoogleAdsRefreshToken = null,
  onConsumePendingGoogleAdsRefreshToken = () => {},
}: Props) {
  ...
  const canManageGoogleAds = membership !== null && (membership.role === 'owner' || membership.role === 'admin')
    ...
    <div className="mx-auto max-w-[1180px] px-10 pt-10 pb-15">
      ...
      {organisationId && (
        <GoogleAdsConnectionPanel
          ...
          canManage={canManageGoogleAds}
          pendingRefreshToken={pendingGoogleAdsRefreshToken}
          onConsumePendingRefreshToken={onConsumePendingGoogleAdsRefreshToken}
        />
      )}
        ...
        <>
          ...
          <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
            ...
            <input
              ...
              type="search"
              aria-label="Search conversion events"
